...
<div id="nav" >
	  <ul>
		    ...
		    <li><a href="queryArticle.html">文章</a></li>
			...
			<!--实现鼠标悬停出现菜单  -->
				<div id="menu" style="position:absolute;top:15;left:0;width:150;height:10;z-index:2;visibility:hidden;"> 
			        ...
			        <a href="<%=path%>/queryPerson.html">修改个人信息</a>
	...
	<form action ="<%=path%>/queryArticle.html" method="post">
		<input type="hidden" name="aab101" value="<%=aab101%>">
		<button style="submit"  formnovalidate="formnovalidate">文章</button>
	</form>
</div>
aab101=<%=aab101%>
<br>
