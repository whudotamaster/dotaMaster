...
<body>
	...
	<c:if test="${aab108==2}">
	   ...
	   -->
			...
			<table border="1" width="95%" align="center">
				<tr>
					<td align="center"><input type="submit" id="ref" name="next"
						value="刷新" formaction="<%=path%>/adminQueryComp.html"> <input
						type="submit" id="del" name="next" value="返回"
						formaction="<%=path%>/adminGo.jsp"></td>
				</tr>
			</table>
		</form>
	</c:if>
